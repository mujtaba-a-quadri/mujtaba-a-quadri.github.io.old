...
<img style="width: 50%" class="ui large right floated rounded image" src="../images/CreateHangoutOptions.png">
...
<img style="width: 50%" class="ui large right floated rounded image" src="../images/CreateHangoutWarning.png">
